...
import com.projeto.acessopuc.service.PasswordRecoveryService;
import com.projeto.acessopuc.service.SendEmailService;
...
public class AcessoController {
    ...
    public String handleRegister(
        ...
        if (userService.exists(email)) {
            return "redirect:/register?erro=cadastro";
        }
